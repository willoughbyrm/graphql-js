...
describe('validateInputValue', () => {
  function test(inputValue: mixed, type: GraphQLInputType, expected: mixed) {
    const errors = [];
    validateInputValue(inputValue, type, (error, path) => {
  ...
  describe('for GraphQLScalar', () => {
    ...
    it('returns an error for undefined result', () => {
      ...
      test(inputValue, TestScalar, [
        {
          error:
            'Expected value of type "TestScalar", found { error: "Some error message" }; Some error message',
          path: [],
        },
      ]);
    });
  ...
  describe('for GraphQLEnum', () => {
    ...
    it('reports thrown non-error', () => {
      ...
      test({}, TestThrowScalar, [
        {
          error:
            'Expected value of type "TestScalar", found {}; Not an error object',
          path: [],
        },
      ]);
    });
...
describe('validateInputLiteral', () => {
  ...
  it('returns an error for missing variables', () => {
    testWithVariables('($var: Int)', {}, '$var', GraphQLInt, [
      {
        error:
  ...
  it('returns an error for null variables for nullable types', () => {
    const TestNonNull = new GraphQLNonNull(GraphQLInt);
